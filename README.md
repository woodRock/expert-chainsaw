...
<body>
  ...
  <div style="float: left; width: 130px;">
    ...
    <div style="display: block; clear: left; color: gray; font-size: x-small;" >Humidity: 95%</div>
    <div style="display: block; clear: left; color: gray; font-size: x-small;" >Wind: 18.01 m/s</div>
