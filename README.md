...
<body>
  ...
  <div style="float: left; width: 130px;">
    ...
    <div style="display: block; clear: left; color: gray; font-size: x-small;" >Wind: 19.55 m/s</div>
    <div style="display: block; clear: left; color: gray; font-size: x-small;" >Pressure: 990hPa</div>
  </div>
