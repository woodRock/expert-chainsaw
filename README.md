...
<body>
  ...
  <div style="float: left; width: 130px;">
    ...
    <div style="display: block; clear: left; color: gray; font-size: x-small;" >Humidity: 100%</div>
    <div style="display: block; clear: left; color: gray; font-size: x-small;" >Wind: 13.89 m/s</div>
